 ...
 */
public class NoBoringFragment_NoDB extends Fragment implements Response.Listener<NoBoringInfo>, Response.ErrorListener{
    ...
    public static NoBoringFragment_NoDB newInstance(String mUrl){
        NoBoringFragment_NoDB f = new NoBoringFragment_NoDB();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mRecyclerViewAdapter = new RecyclerViewAdapter(context, list, new int[]{R.layout.view_pager,
            ...
            public void onItemClick(View view, int position) {
                ...
                int id = (int)itemList.get(position).get("Stories_Id");
